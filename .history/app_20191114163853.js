  ...
  $.getJSON("graphdata/OwnPhoneBy2011.json", function(data) {
    ...
    var chart1 = new Chart(ctx1, {
      ...
      data: {
        ...
        datasets: [
          {
            label: "Less than NGN29,999",
            data: data["Less than NGN29,999"],
            backgroundColor: colors[0],
            borderColor: borderColors[0],
          }, {
            label: "NGN30,000 to NGN49,999",
            data: data["NGN30,000 to NGN49,999"],
            backgroundColor: colors[1],
            borderColor: borderColors[1],
          }, {
            label: "NGN50,000 to NGN99,999",
            data: data["NGN50,000 to NGN99,999"],
            backgroundColor: colors[2],
            borderColor: borderColors[2],
          }, {
            label: "NGN100,000 to NGN299,999",
            data: data["NGN100,000 to NGN299,999"],
            backgroundColor: colors[3],
            borderColor: borderColors[3],
          }, {
            label: "More than NGN300,000",
            data: data["More than NGN300,000"],
      ...
      options: {
        title: {
          display: true,
          text: 'Device Ownership % by Income, 2018'
        },
        scales: {
          yAxes: [
            {
  ...
  $.getJSON("graphdata/AppUsageByAge.json", function(data) {
    ...
    var chart1 = new Chart(ctx1, {
      ...
      options: {
        title: {
          display: true,
          text: 'Percent Change in App Usage between 2017 and 2018'
        },
        scales: {
          yAxes: [
            {
  ...
  $.getJSON("graphdata/InternetSpeed.json", function(data) {
    ...
    var chart1 = new Chart(ctx1, {
      ...
      options: {
        title: {
          display: true,
          text: 'Number of Respondents Willing to Pay More for Internet [2016, 2017, 2018]'
        },
        scales: {
          yAxes: [
            {
  ...
  $.getJSON("graphdata/InternetMoneyValue.json", function(data) {
    ...
    var chart1 = new Chart(ctx1, {
      ...
      options: {
        title: {
          display: true,
          text: 'Value People Were Willing to Pay for Faster Internet [20016, 2017, 2018]'
        },
        scales: {
          yAxes: [
            {
  ...
  $.getJSON("graphdata/BingeWatchersPerYear.json", function(data) {
    ...
    var chart1 = new Chart(ctx1, {
      ...
      options: {
        title: {
          display: true,
          text: '% Of People Who Binge Watch Per Year, 2017-2018'
        },
        scales: {
          yAxes: [
            {
